...
<tr valign="top">
<th colspan="3" style="padding: 5px 5px 7px 5px;text-align:left;">Responsive Booking Page</th>
</tr>
...
<option value ="0" <?php if(get_option('beds24_layout') == 0) echo "selected"; ?>>default</option>
<?php for($i = 1; $i <= 6; $i += 1) { ?>
<option value ="<?php echo $i; ?>" <?php if(get_option('beds24_layout') == $i) echo "selected"; ?>><?php echo $i; ?></option>
<?php } ?>
</select></td>
<td style="padding: 5px 5px 7px 5px;"> <span style="font-style: italic; color: gray;">This is the default layout.</span>
</td>
</tr>


<tr valign="top">
<th colspan="3" style="padding: 5px 5px 7px 5px;text-align:left;">Adaptive Booking Page</th>
</tr>
